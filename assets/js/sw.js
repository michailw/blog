...
// ⚡️ DANGER ZONE ⚡️
// ================
// {% if jekyll.environment == 'production' or site.blog.offline.development %}

// The shell cache keeps "landmark" resources, like CSS and JS, web fonts, etc.
// which won't change between content updates.
// {% assign cv = site.blog.offline.cache_version | default:"1" %}
...
// {% unless site.blog.no_google_fonts or site.no_google_fonts %}
// {% assign gf = true %}
...
const SHELL_FILES = [
  ...
  "{{ '/assets/js/blog-8.0.0.js' | relative_url }}",
  "{{ '/assets/css/blog-8.0.0.css' | relative_url }}",
...
const ASSET_FILES = [
  ...
  /*{% for file in site.blog.offline.precache_assets %}*/ "{% include smart-url.txt url=file %}",
  /*{% endfor %}*/
];
